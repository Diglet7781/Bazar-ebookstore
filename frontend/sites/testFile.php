   ...
   <body>
      <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
         <div class="navbar-left">
            ...
            <img class="logo-dark" src="../img/../contextimages/nav2.png" width="60" height="60" class="d-inline-block align-top" alt="" alt="logo">
            </a>
            <div class="navbar-brand mb-1 h4">
               </span>
               <h2><a href="../css/testFile.php"> BaaZaar </a></h2>
            </div>
         </div>
