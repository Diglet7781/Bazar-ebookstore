    ...
    <body>
        <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
               ...
               if(isset($_SESSION['username'])){
                  if($_SESSION['type']== "Seller"){
                    ...
                    echo'<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">';
                     ...
                     echo "  ";
                     echo '<a class="dropdown-item" href="../../backend/navabarFunctions/logout.php">Logout</a></button>';
                     echo '</div>';
                     echo '</div>';
                  }
                    else {
               ...
               ?>
                    <div class="button">
                        <button type="button" class="btn btn-danger" id="anchor">
                            <?php
                  if(isset($_SESSION['username'])){
                    ...
                    <div class="container dark-grey-text mt-5">
                        ...
                        <div class="row wow fadeIn">
                            ...
                            <div class="col-md-3 mb-4">
                                ...
                                <div class="p-4">
                                    <div class="mb-3">
                                        <a href=""> <span class="badge purple mr-1"><?php echo $productType ?></span> </a>
                                    ...
                                    <!-- Default input -->
                                    <button class="btn btn-danger" type="button"><a href="../../backend/cartPHP/addToCart.php?id=<?php echo $productid?>">addToCart</a></button> <i class="fas fa-shopping-cart ml-1"></i></button>
                                </div>
