...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="../css/slidingOverlayStyles.css">
   ...
   <body>
      ...
      <div class="container" id="container">
         <div class="form-container sign-up-container">
            <form method="post" action="../../backend/functions/signup.php">
         ...
         <div class="form-container sign-in-container ">
            <form action="../backend/login.php" method="post">
               <button type="home" name="homeButton">Home</button>
               <!-- following card necessary for spacing --><div class="card bg-transparent"><div class="card-body"><h5 class="card-title"></h5></div></div><div class="card bg-transparent"><div class="card-body"><h5 class="card-title"></h5></div></div><div class="card bg-transparent"><div class="card-body"><h5 class="card-title"></h5></div></div><!-- previous card necessary for spacing -->
               <h1>Sign In</h1>
               <input type="text" placeholder="Username" name="username">
      ...
      <script src="../js/slidingOverlayJayEs.js"></script>
