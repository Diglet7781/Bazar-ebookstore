...
<html lang = "en">
   ...
   <body>
            ...
            if(isset($_SESSION['username'])){
               if($_SESSION['type']== "Seller"){
                 ...
                 echo'<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">';
                  ...
                  echo '<a class="dropdown-item" href="../../backend/navbarFunctions/logout.php">Logout</a>';
                  echo '</div>';
                  echo '</div>';
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
         ...
         <div class="carousel-inner">
            <div class="carousel-item active">
               <img class="d-block w-100" src="../contextimages/carousel11.jpg" alt="First slide" style="height:300px;">
            ...
            <div class="carousel-item">
               <img class="d-block w-100" src="../contextimages/carousel22.jpg" alt="Second slide" style="height:300px;">
               <div class="carousel-caption d-none d-md-block">
                  <h5>Second Slide</h5>
            ...
            <div class="carousel-item">
               <img class="d-block w-100" src="../contextimages/carousel33.jpg" alt="Third slide" style="height:300px;">
               <div class="carousel-caption d-none d-md-block">
                  <h5>Third Slide </h5>
      ...
      <div class = "label-heading">
         <center>
            <h2 style="color:red;"> Our Best Deals </h2>
         </center>
      </div>
      <!--
         php code begins
      ...
      <div class="row" style="margin:5px; padding-top:10px;" >
         ...
         <div style="padding-left:20px; padding-top:10px;" class="col-md-<?php echo $bootstrapColWidth; ?>">
            <div class="thumbnail">
               ...
               <div >
                  <p style="color:red;"><?php echo $row['productName']; ?></p>
               </div>
               <div  style="color:red;">
