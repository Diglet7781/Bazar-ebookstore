...
<html lang = "en">
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="../css/testFile.css">
      ...
      <!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
         This inclusion triggers the following errors on localhost:
           Uncaught TypeError: Cannot read property 'fn' of undefined at util.js:68 at util.js:10 at bootstrap.min.js:6 at bootstrap.min.js:6 -->
      <style>
         #anchor{
         color: #FFFFFF;
   ...
   <body>
      <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light" >
         <div class="navbar-left">
            ...
            <img class="logo-dark" src="../contextimages/nav2.png" width="50" height="50" class="d-inline-block align-top" alt="" alt="logo">
            </a>
            ...
            if(isset($_SESSION['username'])){
               if($_SESSION['type']== "Seller"){
                 ...
                 echo'<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">';
                  ...
                  echo '<a class="dropdown-item" href="../../backend/navabarFunctions/logout.php">Logout</a>';
                  echo '</div>';
                  echo '</div>';
                  ...
                  echo "  ";
                  echo '<button  class="btn btn-danger"><a href="../../backend/navabarFunctions/logout.php">Logout</a></button>';
               }
                 else {
                   // code...
                    echo "";
      ...
      <?php
         require_once"../../backend/setUps/dblogin.php";
      ...
      <html lang="en">
         ...
         <body>
               ...
               <tbody>
                  <tr>
                     ...
                     <td class="actions" data-th="">
                        <a href='../../backend/adminOptions/editInventory.php?id=<?php echo $productid?>' class="btn btn-info btn-sm"><i class="fa fa-refresh"></i>Update</a>
                        <a href="../../backend/adminOptions/deleteItem.php?id=<?php echo $productid?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i>delete</a>
                     </td>
                  </tr>
                  <?php
                     }
            ...
            <button>  <a href="addInventory.php" class="btn btn-success"><i class="fa fa-file"></i>Add</a></button>
