               ...
               <?php
                  if(isset($_SESSION['username'])){
                     if($_SESSION['type']== "Seller"){
                        ...
                        echo '<button  class="btn btn-danger"><a href="../../backend/navbarFunctions/logout.php">Logout</a></button>';
         ...
         <div class="cart-items">
            ...
            <div class="cart-row">
               ...
               <div class="cart-quantity cart-column">
                  ...
                  <button class="btn btn-danger" type="button"><a href="../backend/cartPHP/removeCart.php?id=<?php echo $productid?>">REMOVE</a></button>
               </div>
            </div>
            <?php
               }
