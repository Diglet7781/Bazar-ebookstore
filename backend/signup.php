...
if (isset($_POST["submit"])){
    if($_POST['fname']=="" || $_POST['lname']=="" || $_POST['email']=="" || $_POST['accountType']=="" || $_POST['username']=="" || $_POST['password']=="" || $_POST['confirm-password']=="" ){
        echo "<script> alert('Empty fields');  window.location.href='../frontend/userAccess.php';  </script>";
    }else{
    ...
    if($rowsusername->num_rows>0){
        ...
        echo "<script> alert('the username already exists');  window.location.href='../frontend/userAccess.php';  </script>";
    }else if($rowsemail->num_rows>0){
      //  echo "the email already exists";
          echo "<script> alert('the email already exists');  window.location.href='../frontend/userAccess.php';  </script>";
    }
    else{
