<?php
    ...
    if (isset($_POST["submit"])){
        ...
        if($connect->query($sql) === TRUE){
            ...
            header("Location:../../frontend/sites/viewInventory.php");
        }else{
...
<html lang = "en">
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="../../frontend/css/testFile.css">
      <link rel = "stylesheet" href ="../../frontend/css/navBarAndFooterStyles.css" rel="stylesheet"/>
      <style>
         #anchor{
            color: #FFFFFF;
   ...
   <body>
      <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light" >
         <div class="navbar-left">
            ...
            <img class="logo-dark" src="../../frontend/contextimages/nav2.png" width="50" height="50" class="d-inline-block align-top" alt="" alt="logo">
            </a>
            <div class="navbar-brand mb-1 h4 mr-lg-5">
               </span>
               <h2><a href="../../frontend/sites/homePage.php"> BaaZaar </a></h2>
            </div>
         </div>
         ...
         <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            ...
            <button type="button" class="btn btn-danger" id="anchor"><?php
                    ...
                    if(isset($_SESSION['username'])){
                        ...
                        echo '<a href="../../frontend/sites/userAccess.php">GetStarted</a>';
                        }
                        ?>
               </button>
               ...
               if(isset($_SESSION['username'])){
                  if($_SESSION['type']== "Seller"){
                     echo '<button  class="btn btn-danger"><a href="../../frontend/sites/profilePage.php">View Profile</a></button>';
                     echo "   ";
                     echo '<button  class="btn btn-danger"><a href="../../frontend/sites/viewInventory.php">View Inventory</a></button>';
                     echo "   ";
                     echo '<button class="btn btn-danger"><a href="../../frontend/sites/addInventory.php">Add Inventory</a></button>';
                     echo "   ";
                     echo '<button  class="btn btn-danger"><a href="../../frontend/sites/cart-view.php">View Cart</a></button>';
                     ...
                     echo '<button  class="btn btn-danger"><a href="../../frontend/sites/cart-view.php">View Cart</a></button>';
                     echo "  ";
                     echo '<button  class="btn btn-danger"><a href="../navbarFunctions/logout.php">Logout</a></button>';
                  }else{
                     echo "";
                  }
               }
...
<div class="my-5 pt-5 text-muted text-center text-small"> </div><div class="my-5 pt-5 text-muted text-center text-small"></div>
         ...
         <div class="row">
            <div class="col-md-2 mt-md-0 mt-3">
               <h5 class="text-monospace text-warning">
                  <img src="../../frontend/contextimages/nav3.png" width="60" height="60" alt=""> BaZaar
               </h5>
